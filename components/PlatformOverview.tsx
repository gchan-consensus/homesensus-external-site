  ...
  return (
    <section className="py-16 px-4 md:py-20 platform-overview-gradient">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Subheading */}
        <p className="text-base text-[#717184] text-center max-w-4xl mx-auto mb-10 md:mb-12 sm:text-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          >
            ...
            <div className="relative flex h-full flex-col justify-between min-h-[200px]">
              <div className="flex items-center gap-3">
                <div className="rounded-full bg-[#0a0a0a]/10 p-2">
          ...
          >
            <div className="flex h-full flex-col justify-between min-h-[200px]">
              ...
              <div>
                <div className="text-2xl font-semibold tracking-tight">Maximize ROI</div>
